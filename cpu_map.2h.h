...
#define PORT_NONE (*((uint8_t *)0xFFFF))
  ...
  #define CONTROL_RESET_BIT         3  // MEGA2560 Analog Pin A11
  #define CONTROL_FEED_HOLD_BIT     4  // MEGA2560 Analog Pin A12
  #define CONTROL_CYCLE_START_BIT   5 // MEGA2560 Analog Pin A13
  #define CONTROL_SAFETY_DOOR_BIT   6  // MEGA2560 Analog Pin A14
  ...
  #define PROBE_BIT       7  // MEGA2560 Analog Pin A15
  ...
  // If enabled, define the pin configuration for the SD interface.
    ...
    #define SD_CHIPSELECT 52
    #define SD_CARDDETECT 53 //[RAMPS14-SMART-ADAPTER]
  #endif
  ...
  // Define the pin configuration for the LCD interface.
    #define LCD_PIN_EN 39 //[RAMPS14-SMART-ADAPTER]
    #define LCD_PIN_RW 40 //[RAMPS14-SMART-ADAPTER]
    #define LCD_PIN_RS 41 //[RAMPS14-SMART-ADAPTER]
    #define LCD_PIN_D4 45 //[RAMPS14-SMART-ADAPTER]
    #define LCD_PIN_D5 44 //[RAMPS14-SMART-ADAPTER]
    #define LCD_PIN_D6 43 //[RAMPS14-SMART-ADAPTER]
    #define LCD_PIN_D7 42 //[RAMPS14-SMART-ADAPTER]
  ...
  // Define the pin configuration for the UI Rotary Encoder interface.
    #define UI_ENCODER_A_PINBTN1 46 //[RAMPS14-SMART-ADAPTER]
    #define UI_ENCODER_A_PINBTN2 47 //[RAMPS14-SMART-ADAPTER]
    ...
    #define UI_ENCODER_A_PIN1 46 //[RAMPS14-SMART-ADAPTER]
    #define UI_ENCODER_A_PIN2 47 //[RAMPS14-SMART-ADAPTER]
    #define UI_ENCODER_A_PIN1_ENABLE_PULLUP
    #define UI_ENCODER_A_PIN2_ENABLE_PULLUP
    
    #define UI_ENCODER_B_MODE 2
    #define UI_ENCODER_B_PIN1 48 //[RAMPS 1.4]
    #define UI_ENCODER_B_PIN2 49 //[RAMPS 1.4]
  ...
  // Define the pin configuration for the Matrix Keypad interface.
    #define UI_MATRIX_KEYPAD_PIN_R1 A0
    #define UI_MATRIX_KEYPAD_PIN_R2 A1
    #define UI_MATRIX_KEYPAD_PIN_R3 A2
    #define UI_MATRIX_KEYPAD_PIN_R4 A3
    #define UI_MATRIX_KEYPAD_PIN_C1 A4
    #define UI_MATRIX_KEYPAD_PIN_C2 A5
    #define UI_MATRIX_KEYPAD_PIN_C3 A6
    #define UI_MATRIX_KEYPAD_PIN_C4 A7
